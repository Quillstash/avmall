...
import { Download, MoreHorizontal, AlertTriangle, Clock, CheckCircle2, Plus } from "lucide-react";
...
import { type ReturnListRow, type ReturnStatus } from "@/lib/admin-mock-data";
...
export function ReturnsClient({ returns: RETURNS }: ReturnsClientProps) {
  ...
  }, [RETURNS, view, search, statusValues]);
